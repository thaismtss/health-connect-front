...
export default function Home() {
  return (
    <main className="flex h-[calc(100vh-300px)] md:h-screen w-full flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-between h-40">
        <div>
          <h1 className="hidden md:block text-4xl font-bold text-center text-primary mb-10">
            HealthConnect
          </h1>
          <p className="text-3xl text-primary font-bold mb-6 md:text-xl text-center">
